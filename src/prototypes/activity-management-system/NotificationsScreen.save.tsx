...
const NotificationsScreen = ({
  ...
  formatDate,
  events,
  currentViewMode = 'notifications' // Default to notifications view
}: {
  ...
  return (
    <div className="max-w-md mx-auto bg-slate-50 h-full flex flex-col min-h-screen max-h-screen overflow-hidden">
      {/* Header */}
