...
const ParcelPrototype3 = () => {
  ...
  return (
    ...
    >
      <h1 className="absolute top-4 right-4 z-20 text-3xl font-bold bg-white px-4 py-2 rounded-lg shadow-lg">
        Parcel Prototype 3 - Shapes with Rotation
      </h1>
...
export default ParcelPrototype3;