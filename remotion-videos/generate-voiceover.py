#!/usr/bin/env python3
"""
Generate French voiceover for crop creation tutorial video
...
segments = [
    {
        "text": "Découvrez comment ajouter une nouvelle culture en quatre étapes simples.",
...
print("Commande: npm run video:add-voiceover")
